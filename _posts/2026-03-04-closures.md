...
<script>
function openInPlayground(sexp) {
  window.open('{{ "/playground" | relative_url }}#proof=' + encodeURIComponent(sexp), '_blank');
}
</script>
...
e ∈ Expr ::=
    ...
    | (- e)                          ← Unary negation
    | (+ e₁ e₂)                     ← Binary addition
    | (if0 e_guard e_true e_false)   ← Conditional (zero test)
    | (let ([x e]) e_body)           ← Let binding
...
<div data-proof-tree='(("If0-True" :right) "ρ ⊢ e_guard ⇓ 0" "ρ ⊢ e_true ⇓ v" --- "ρ ⊢ (if0 e_guard e_true e_false) ⇓ v")' data-proof-tree-zoom="false"></div>
</div>
...
<div data-proof-tree='(("If0-False" :right) "ρ ⊢ e_guard ⇓ i" "i ≠ 0" "ρ ⊢ e_false ⇓ v" --- "ρ ⊢ (if0 e_guard e_true e_false) ⇓ v")' data-proof-tree-zoom="false"></div>
</div>
...
<div data-proof-tree='((Let :right) "ρ ⊢ e ⇓ v₁" "ρ[x ↦ v₁] ⊢ e_body ⇓ v₂" --- "ρ ⊢ (let ([x e]) e_body) ⇓ v₂")' data-proof-tree-zoom="false"></div>
</div>
...
<button class="cl-btn" onclick="openInPlayground(window._ex1sexp)" style="margin-top:10px;">Open in Playground</button>
</div>
<script>
(function() {
  ...
  details.addEventListener('toggle', function() {
    if (details.open && !rendered) {
      rendered = true;
      ProofTree.renderReadonly(window._ex1sexp, document.getElementById('exercise1-solution'), { zoom: false });
    }
  });
})();
</script>
...
<button class="cl-btn" onclick="openInPlayground(window._ex2sexp)" style="margin-top:10px;">Open in Playground</button>
</div>
<script>
(function() {
  ...
  details.addEventListener('toggle', function() {
    if (details.open && !rendered) {
      rendered = true;
      ProofTree.renderReadonly(window._ex2sexp, document.getElementById('exercise2-solution'), { zoom: false });
    }
  });
})();
</script>
...
<div data-proof-tree='((App :right) "ρ ⊢ e₁ ⇓ ⟨λ (x) e_body , ρ_clo⟩" "ρ ⊢ e₂ ⇓ v_arg" "ρ_clo[x ↦ v_arg] ⊢ e_body ⇓ v" --- "ρ ⊢ (e₁ e₂) ⇓ v")' data-proof-tree-zoom="false"></div>
</div>

**Important:** we evaluate the body in **ρ_clo** (the environment from when the function was *defined*), **not** in ρ (the environment at the *call site*). This is called **lexical scoping**.
...
<button class="cl-btn" onclick="openInPlayground(window._ex3sexp)" style="margin-top:10px;">Open in Playground</button>
</div>
<script>
(function() {
  ...
  details.addEventListener('toggle', function() {
    if (details.open && !rendered) {
      rendered = true;
      ProofTree.renderReadonly(window._ex3sexp, document.getElementById('exercise3-solution'), { zoom: false });
    }
  });
})();
</script>
...
<button class="cl-btn" onclick="openInPlayground(window._optAsexp)" style="margin-top:10px;">Open in Playground</button>
</div>
<script>
(function() {
  ...
  details.addEventListener('toggle', function() {
    if (details.open && !rendered) {
      rendered = true;
      ProofTree.renderReadonly(window._optAsexp, document.getElementById('optA-solution'), { zoom: false });
    }
  });
})();
</script>
...
<button class="cl-btn" onclick="openInPlayground(window._optBsexp)" style="margin-top:10px;">Open in Playground</button>
</div>
<script>
(function() {
  ...
  details.addEventListener('toggle', function() {
    if (details.open && !rendered) {
      rendered = true;
      ProofTree.renderReadonly(window._optBsexp, document.getElementById('optB-solution'), { zoom: false });
    }
  });
})();
</script>
...
(function() {
  ...
  document.getElementById('cert-playground-btn').addEventListener('click', function() {
    var input = document.getElementById('cert-input').value.trim();
    if (input) openInPlayground(input);
  });
})();
</script>
