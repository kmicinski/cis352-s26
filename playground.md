...
(function() {
  ...
  var theoryExamples = {
    ...
    'g3ip': [
      ...
      { label: '\u2227-distrib-\u2228: P \u2227 (Q \u2228 R) \u21D2 (P \u2227 Q) \u2228 (P \u2227 R)', key: 'g3-distrib' },
      { label: 'Ex falso: P \u2227 \u22A5 \u21D2 Q', key: 'g3-bot-and' },
      { label: 'S combinator: \u21D2 (P \u2192 Q \u2192 R) \u2192 (P \u2192 Q) \u2192 P \u2192 R', key: 'g3-s-comb' },
    ],
    'propnd': [
    ...
    'stlc': [
      ...
      { label: 'Negate fn: \u22A2 (\u03BB (x : int) (- x)) : int \u2192 int', key: 'stlc-neg-fn' },
      { label: 'If0: \u22A2 (if0 0 42 0) : int', key: 'stlc-if' },
      { label: 'Nested let: \u22A2 (let ([x 5]) (let ([y ...]) (+ x y))) : int', key: 'stlc-nested-let' },
    ],
    'systemf': [
  ...
  var exampleData = {
    ...
    'g3-distrib': '(("\u2227L" :right) (("\u2228L" :right) (("\u2228R\u2081" :right) (("\u2227R" :right) ((Ax :right) --- "P, Q \u21D2 P") ((Ax :right) --- "P, Q \u21D2 Q") --- "P, Q \u21D2 P \u2227 Q") --- "P, Q \u21D2 (P \u2227 Q) \u2228 (P \u2227 R)") (("\u2228R\u2082" :right) (("\u2227R" :right) ((Ax :right) --- "P, R \u21D2 P") ((Ax :right) --- "P, R \u21D2 R") --- "P, R \u21D2 P \u2227 R") --- "P, R \u21D2 (P \u2227 Q) \u2228 (P \u2227 R)") --- "P, Q \u2228 R \u21D2 (P \u2227 Q) \u2228 (P \u2227 R)") --- "P \u2227 (Q \u2228 R) \u21D2 (P \u2227 Q) \u2228 (P \u2227 R)")',
    'g3-bot-and': '(("\u2227L" :right) (("\u22A5L" :right) --- "P, \u22A5 \u21D2 Q") --- "P \u2227 \u22A5 \u21D2 Q")',
    'g3-s-comb': '(("\u2192R" :right) (("\u2192R" :right) (("\u2192R" :right) (("\u2192L" :right) ((Ax :right) --- "P \u2192 Q \u2192 R, P \u2192 Q, P \u21D2 P") (("\u2192L" :right) ((Ax :right) --- "P \u2192 Q, Q \u2192 R, P \u21D2 P") (("\u2192L" :right) ((Ax :right) --- "Q \u2192 R, Q, P \u21D2 Q") ((Ax :right) --- "R, Q, P \u21D2 R") --- "Q, Q \u2192 R, P \u21D2 R") --- "Q \u2192 R, P \u2192 Q, P \u21D2 R") --- "P \u2192 Q \u2192 R, P \u2192 Q, P \u21D2 R") --- "P \u2192 Q \u2192 R, P \u2192 Q \u21D2 P \u2192 R") --- "P \u2192 Q \u2192 R \u21D2 (P \u2192 Q) \u2192 P \u2192 R") --- "\u21D2 (P \u2192 Q \u2192 R) \u2192 (P \u2192 Q) \u2192 P \u2192 R")',
    ...
    'stlc-neg-fn': '(("T-Lam" :right) (("T-Neg" :right) (("T-Var" :right) --- "x : int \u22A2 x : int") --- "x : int \u22A2 (- x) : int") --- "\u22A2 (\u03BB (x : int) (- x)) : int \u2192 int")',
    'stlc-if': '(("T-If" :right) (("T-Int" :right) --- "\u22A2 0 : int") (("T-Int" :right) --- "\u22A2 42 : int") (("T-Int" :right) --- "\u22A2 0 : int") --- "\u22A2 (if0 0 42 0) : int")',
    'stlc-nested-let': '(("T-Let" :right) (("T-Int" :right) --- "\u22A2 5 : int") (("T-Let" :right) (("T-Add" :right) (("T-Var" :right) --- "x : int \u22A2 x : int") (("T-Int" :right) --- "x : int \u22A2 1 : int") --- "x : int \u22A2 (+ x 1) : int") (("T-Add" :right) (("T-Var" :right) --- "x : int, y : int \u22A2 x : int") (("T-Var" :right) --- "x : int, y : int \u22A2 y : int") --- "x : int, y : int \u22A2 (+ x y) : int") --- "x : int \u22A2 (let ([y (+ x 1)]) (+ x y)) : int") --- "\u22A2 (let ([x 5]) (let ([y (+ x 1)]) (+ x y))) : int")',
